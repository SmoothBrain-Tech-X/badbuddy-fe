...
const venueService = {
  searchVenues: async (params: {
    ...
    const response = await fetch(
      `https://general-badbuddy-be.tu4rl4.easypanel.host/api/venues/search?${queryParams}`
    );
    ...
    <Grid.Col span={{ base: 12, sm: 6, md: 4 }}>
      <Group grow>
        ...
        <Button
          ...
          rightSection={
            filtersVisible ? <IconChevronUp size={16} /> : <IconChevronDown size={16} />
          }
        >
          Filters
        </Button>
...
}> = ({ visible, priceRange, onPriceRangeChange, selectedFacilities, onFacilitiesChange }) => (
  <Collapse in={visible}>
...
const ActiveFilters: React.FC<{
  ...
  onClearAll: () => void;
}> = ({ selectedDistrict, selectedFacilities, onClearDistrict, onClearFacility, onClearAll }) => {
    ...
    <Group mb="xl">
      ...
      {selectedDistrict && (
        <Badge
          variant="light"
          rightSection={
            <ActionIcon variant="transparent" size="sm" onClick={onClearDistrict}>
              ×
            </ActionIcon>
          }
        >
      ...
      {selectedFacilities.map((facility, index) => (
        <Badge
          ...
          variant="light"
          rightSection={
            <ActionIcon variant="transparent" size="sm" onClick={() => onClearFacility(facility)}>
              ×
            </ActionIcon>
          }
        >
...
}> = ({ total, limit, page, onPageChange, onLimitChange }) => {
        ...
        <Stack mb="xl" align="center">
          <Title
            style={{
              fontSize: rem(36),
              background:
                'linear-gradient(45deg, var(--mantine-color-blue-6), var(--mantine-color-indigo-5))',
