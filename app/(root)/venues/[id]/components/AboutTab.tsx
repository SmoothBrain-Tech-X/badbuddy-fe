...
import { IconAirConditioning, IconParking, IconShoe, IconWifi } from '@tabler/icons-react';
import { Group, List, Paper, SimpleGrid, Stack, Text, ThemeIcon } from '@mantine/core';
...
const AboutTab = ({ venueData, facilities }: { venueData: Venue; facilities: string[] }) => (
  <Stack>
