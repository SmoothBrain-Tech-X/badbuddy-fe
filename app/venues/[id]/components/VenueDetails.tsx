...
import { Review, CreateReviewDTO, Venue, Court } from '@/services';
...
const VenueDetails = ({ venueData, facilities, reviews, onBookCourt, onSubmitReview }: VenueDetailsProps) => {
    return (
        <Stack gap="xl" className="max-w-5xl mx-auto">
            {/* About Section */}
            <Card shadow="sm" radius="md" withBorder>
                <Stack gap="lg">
                    <Text size="xl" fw={600} className="text-blue-600">About</Text>
            ...
            <Card shadow="sm" radius="md" withBorder>
                <Stack gap="lg">
                    <Text size="xl" fw={600} className="text-blue-600">Available Courts</Text>
            ...
            <Card shadow="sm" radius="md" withBorder>
                <Stack gap="lg">
                    <Text size="xl" fw={600} className="text-blue-600">Reviews</Text>
